...
extern void heap_init(heap_t* h, vertex_set_t* src, graph_t* g);

extern void heap_swap(int32_t id1, int32_t id2, heap_t * h, graph_t * g);

extern void heap_percolatedown(int32_t id, graph_t* g, heap_t * h);

extern int32_t heap_pop(graph_t * g, heap_t * h);

extern void heap_percolateup(int32_t id, graph_t * g, heap_t* h);
